  ...
  return (
    ...
    <section className="">
        ...
        <div className="row mt-3">
            ...
            <p>
                <a href="#!" className="text-reset">Pricing Policy</a>
            </p>
            <p>
                <a href="#!" className="text-reset">Setting Policy</a>
            </p>
            <p>
                <a href="#!" className="text-reset">Order Policy</a>
            </p>
            <p>
    ...
    <div className="text-center p-4">
        © 2021 Copyright:
        <a className="text-reset fw-bold" href="https://LerryLazy.com/">LerryLazy.com</a>
    </div>
    </footer>
  );
}
